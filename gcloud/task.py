...
from keras.models import load_model, generator_input
    ...
    if epoch > 0 and epoch % self.eval_frequency == 0:
      ...
      if len(checkpoints) > 0:
        ...
        loss, acc = census_model.evaluate_generator(
            generator_input(self.eval_files, chunk_size=CHUNK_SIZE),
            steps=self.steps)
...
def dispatch(train_files,
             ...
             num_epochs,
             checkpoint_epochs):
  itracker = get_eye_tracker_model(3, 64, 64)
  itracker = compile_model(itracker, 1e-3)
  ...
  itracker.fit_generator(
      generator_input(train_files, chunk_size=CHUNK_SIZE),
